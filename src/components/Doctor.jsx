...
const Doctor = ({doctor}) => {
    const { image_url, name,availability_days, speciality, registration_number, experience } = doctor || {}
    const today = new Date().toLocaleDateString("en-US", { weekday: "long" });
    const isAvailable = availability_days.includes(today);
    return (
        <div className='border-2 border-gray-300 rounded-2xl p-5 md:p-6 flex flex-col items-center justify-center gap-4 md:gap-6 shadow hover:shadow-lg duration-700 transform hover:-translate-y-1 bg-white'>
            <div>
            ...
            <div className='space-y-2'>
                ...
                <Link to={`lawyer-details/${registration_number}`}>

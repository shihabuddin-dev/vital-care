...
const Hero = () => {
    return (
        <div className='bg-linear-to-b from-[#efefef] to-white border-2 border-white py-8 md:py-12 rounded-2xl px-2'>
            {/* header part  */}
            ...
            <form
                ...
                //     setSearchText('')
                // }}
                className='flex gap-4 flex-col md:flex-row pt-6 justify-center items-center'>
